    ...
    try {
      const response = await fetch('/api/auth/register', {
        ...
        body: JSON.stringify({
          ...
          role: userType === 'owner' ? 'owner' : 'traveler'
        })
      });
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
            ...
            <div className="space-y-6">
              ...
              <div
                ...
                className={`group cursor-pointer bg-white rounded-3xl p-8 border-2 transition-all duration-300 ${userType === 'traveler'
                  ? 'border-black shadow-xl scale-105'
                  : 'border-gray-200 hover:border-gray-300 hover:shadow-lg'
                  }`}
              >
                <div className="flex items-start gap-4">
                  <div className={`w-16 h-16 rounded-2xl flex items-center justify-center transition-colors ${userType === 'traveler' ? 'bg-black text-white' : 'bg-gray-100 text-gray-600 group-hover:bg-gray-200'
                    }`}>
                    <User size={28} />
                  </div>
              ...
              <div
                ...
                className={`group cursor-pointer bg-white rounded-3xl p-8 border-2 transition-all duration-300 ${userType === 'owner'
                  ? 'border-black shadow-xl scale-105'
                  : 'border-gray-200 hover:border-gray-300 hover:shadow-lg'
                  }`}
              >
                <div className="flex items-start gap-4">
                  <div className={`w-16 h-16 rounded-2xl flex items-center justify-center transition-colors ${userType === 'owner' ? 'bg-black text-white' : 'bg-gray-100 text-gray-600 group-hover:bg-gray-200'
                    }`}>
                    <Building2 size={28} />
                  </div>
                  <div className="flex-1">
